...
WORKDIR /app
COPY --from=backend-builder /FlareBot/.venv ./.venv
COPY --from=backend-builder /FlareBot/src ./src
COPY --from=backend-builder /FlareBot/pyproject.toml .
COPY --from=backend-builder /FlareBot/README.md .
